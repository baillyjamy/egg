...
class InstallRavenOS:
    ...
    def install_raven_os(self):
        ...
        InstallQueue().add(BasicInstallCommandEvent(BasicInstallCommandEvent.exec_command.__name__, command=("grub_var=`which grub2-install > /dev/null 2>&1 && echo grub2 || echo grub`; boot_uuid=`blkid -s PARTUUID -o value /dev/sdb2`; echo -e \""+ grub_cfg + "\" >> " + raven_install_path + "/boot/$grub_var/grub.cfg")))
